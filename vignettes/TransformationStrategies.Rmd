...
set_field_na <- function(ptbl_pedigree, 
  ...
  tbl_pedigree_vna <- ptbl_pedigree %>% dplyr::mutate(.[[pn_pk_col_idx]] := replace(ptbl_pedigree[,pn_pk_col_idx], vec_row_idx, NA))
...
```{r}
tbl_pedigree_vna_func <- set_field_na(ptbl_pedigree = tbl_pedigree, 
                                      pvec_rec_pk = vec_rec_pk, 
                                      pn_field_idx = getTvdIdColsDsch()$MutterIdCol)
```
